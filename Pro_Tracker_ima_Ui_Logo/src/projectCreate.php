                    ...
                    <form class="form-group" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Project Name:</label><br><?php if (isset($validateError['pro_name'])) {
                            ...
                            <div class="form-group col-md-6">
                                <label>Project Owner Name:</label><br><?php if (isset($validateError['pro_owner_id'])) {
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>Address:</label><br><?php if (isset($validateError['address'])) {
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label>Approximated Budget</label><br><?php if (isset($validateError['approx_budget'])) {
                            ...
                            <div class="form-group col-md-4">
                                <label>Start Date :</label><br><?php if (isset($validateError['start_date'])) {
                                                                echo '<label class="text-danger">  ' . $validateError['start_date'] . '</label>';
                                                            } ?>
                                <input type="date" class="form-control" name="start_date" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label>End Date:</label><br><?php if (isset($validateError['end_date'])) {
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                               <div align="left"> <label>Plan Document:</label></div><?php if (isset($validateError['planDocError1'])) {
                            ...
                            <div class="form-group col-md-6">
                               <div align="left"> <label>BOQ Document:</label></div><?php if (isset($validateError['boqDocError1'])) {
