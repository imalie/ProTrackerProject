...
for ($i = 0; $i < $dataset_count; $i++) {
    if ($_POST['data_set'][$i]['type'] == "payment") {
        $dbQueryStage = "INSERT INTO payment (customer_id, project_id, amount, release_user) VALUES ('".$_POST['data_set'][$i]['cus_id']."','".$_POST['data_set'][$i]['pro_id']."','".$_POST['data_set'][$i]['payment']."','".$_SESSION['userID']."');";
