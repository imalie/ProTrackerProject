        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    <h3 style="color : #3574d2e8"> Customer Information</h3>

        <div class="col-lg-12 col-md-6 col-sm-6" style="background-color: white">
              <div class="card card-stats">
                  ...
                  <h3 class="card-title"> 
                    ...
                    <form class="container" method="post" enctype="multipart/form-data" style="padding-top : 20px ; padding-left :40px">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        <button class="btn btn-primary" style="margin-top: 24px; float: right;" name="update" value="Update">Update</button>
                                    </div>
                                </div>
                                <br>
                            </div>
