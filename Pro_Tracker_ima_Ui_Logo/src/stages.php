                        ...
                        <form id="form_01">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <th class="w-25"><input type="text" id="pro_id" placeholder="Project ID" class="form-control" disabled></th>
                                    <th width="15%">Project Name</th>
                                    <th class="w-75"><input type="text" id="pro_name" placeholder="Project Name" class="form-control"></th>
                                </tr>
                            </table>
                        </form>
                        <form id="form_02">
                            ...
                            <div class="border rounded p-1">
                                ...
                                <div class="border rounded">
                                    <table class="table table-borderless" id="item_table" align="left">
                                        <tr align="left">
