                     ...
                     <h4>Project Count</h4>
                        <table class="table table-hover table-striped table-responsive-sm">
                            ...
                            <tbody>
                                ...
                                $dbQuery = "SELECT COUNT(project.id),customer.first_name,customer.last_name 
                                            FROM project JOIN customer ON project.pro_owner_id = customer.id GROUP BY customer.first_name;";
